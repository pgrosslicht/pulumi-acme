...
__all__ = ['AcmeRegistrationArgs', 'AcmeRegistration']

@pulumi.input_type
class AcmeRegistrationArgs:
    def __init__(__self__, *,
                 account_key_pem: pulumi.Input[str],
                 email_address: pulumi.Input[str],
                 external_account_binding: Optional[pulumi.Input['AcmeRegistrationExternalAccountBindingArgs']] = None):
        """
    ...
    def external_account_binding(self) -> Optional[pulumi.Input['AcmeRegistrationExternalAccountBindingArgs']]:
        return pulumi.get(self, "external_account_binding")

    @external_account_binding.setter
    def external_account_binding(self, value: Optional[pulumi.Input['AcmeRegistrationExternalAccountBindingArgs']]):
        pulumi.set(self, "external_account_binding", value)


@pulumi.input_type
class _AcmeRegistrationState:
    def __init__(__self__, *,
...
class AcmeRegistration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 account_key_pem: Optional[pulumi.Input[str]] = None,
                 email_address: Optional[pulumi.Input[str]] = None,
                 external_account_binding: Optional[pulumi.Input[pulumi.InputType['AcmeRegistrationExternalAccountBindingArgs']]] = None,
                 __props__=None):
        """
        Create a AcmeRegistration resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AcmeRegistrationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a AcmeRegistration resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param AcmeRegistrationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AcmeRegistrationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AcmeRegistrationArgs.__new__(AcmeRegistrationArgs)
        ...
        super(AcmeRegistration, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            email_address: Optional[pulumi.Input[str]] = None,
            external_account_binding: Optional[pulumi.Input[pulumi.InputType['AcmeRegistrationExternalAccountBindingArgs']]] = None,
            registration_url: Optional[pulumi.Input[str]] = None) -> 'AcmeRegistration':
        """
        ...
        __props__ = _AcmeRegistrationState.__new__(_AcmeRegistrationState)

        __props__.__dict__["account_key_pem"] = account_key_pem
        __props__.__dict__["email_address"] = email_address
        __props__.__dict__["external_account_binding"] = external_account_binding
        __props__.__dict__["registration_url"] = registration_url
        return AcmeRegistration(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="externalAccountBinding")
    def external_account_binding(self) -> pulumi.Output[Optional['outputs.AcmeRegistrationExternalAccountBinding']]:
        return pulumi.get(self, "external_account_binding")
