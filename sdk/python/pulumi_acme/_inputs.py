...
@pulumi.input_type
class AcmeCertificateDnsChallengeArgs:
...
@pulumi.input_type
class AcmeCertificateHttpChallengeArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class AcmeCertificateHttpMemcachedChallengeArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class AcmeCertificateHttpWebrootChallengeArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class AcmeCertificateTlsChallengeArgs:
    def __init__(__self__, *,
                 port: Optional[pulumi.Input[int]] = None):
        if port is not None:
            pulumi.set(__self__, "port", port)
...
@pulumi.input_type
class AcmeRegistrationExternalAccountBindingArgs:
    def __init__(__self__, *,
