...
__all__ = ['AcmeCertificateArgs', 'AcmeCertificate']

@pulumi.input_type
class AcmeCertificateArgs:
    def __init__(__self__, *,
                 ...
                 dns_challenges: Optional[pulumi.Input[Sequence[pulumi.Input['AcmeCertificateDnsChallengeArgs']]]] = None,
                 http_challenge: Optional[pulumi.Input['AcmeCertificateHttpChallengeArgs']] = None,
                 http_memcached_challenge: Optional[pulumi.Input['AcmeCertificateHttpMemcachedChallengeArgs']] = None,
                 http_webroot_challenge: Optional[pulumi.Input['AcmeCertificateHttpWebrootChallengeArgs']] = None,
                 ...
                 tls_challenge: Optional[pulumi.Input['AcmeCertificateTlsChallengeArgs']] = None):
        """
    ...
    def dns_challenges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AcmeCertificateDnsChallengeArgs']]]]:
        return pulumi.get(self, "dns_challenges")

    @dns_challenges.setter
    def dns_challenges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AcmeCertificateDnsChallengeArgs']]]]):
        pulumi.set(self, "dns_challenges", value)

    @property
    @pulumi.getter(name="httpChallenge")
    def http_challenge(self) -> Optional[pulumi.Input['AcmeCertificateHttpChallengeArgs']]:
        return pulumi.get(self, "http_challenge")

    @http_challenge.setter
    def http_challenge(self, value: Optional[pulumi.Input['AcmeCertificateHttpChallengeArgs']]):
        pulumi.set(self, "http_challenge", value)

    @property
    @pulumi.getter(name="httpMemcachedChallenge")
    def http_memcached_challenge(self) -> Optional[pulumi.Input['AcmeCertificateHttpMemcachedChallengeArgs']]:
        return pulumi.get(self, "http_memcached_challenge")

    @http_memcached_challenge.setter
    def http_memcached_challenge(self, value: Optional[pulumi.Input['AcmeCertificateHttpMemcachedChallengeArgs']]):
        pulumi.set(self, "http_memcached_challenge", value)

    @property
    @pulumi.getter(name="httpWebrootChallenge")
    def http_webroot_challenge(self) -> Optional[pulumi.Input['AcmeCertificateHttpWebrootChallengeArgs']]:
        return pulumi.get(self, "http_webroot_challenge")

    @http_webroot_challenge.setter
    def http_webroot_challenge(self, value: Optional[pulumi.Input['AcmeCertificateHttpWebrootChallengeArgs']]):
    ...
    def tls_challenge(self) -> Optional[pulumi.Input['AcmeCertificateTlsChallengeArgs']]:
        return pulumi.get(self, "tls_challenge")

    @tls_challenge.setter
    def tls_challenge(self, value: Optional[pulumi.Input['AcmeCertificateTlsChallengeArgs']]):
        pulumi.set(self, "tls_challenge", value)


@pulumi.input_type
class _AcmeCertificateState:
    def __init__(__self__, *,
...
class AcmeCertificate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 common_name: Optional[pulumi.Input[str]] = None,
                 disable_complete_propagation: Optional[pulumi.Input[bool]] = None,
                 dns_challenges: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AcmeCertificateDnsChallengeArgs']]]]] = None,
                 http_challenge: Optional[pulumi.Input[pulumi.InputType['AcmeCertificateHttpChallengeArgs']]] = None,
                 http_memcached_challenge: Optional[pulumi.Input[pulumi.InputType['AcmeCertificateHttpMemcachedChallengeArgs']]] = None,
                 http_webroot_challenge: Optional[pulumi.Input[pulumi.InputType['AcmeCertificateHttpWebrootChallengeArgs']]] = None,
                 key_type: Optional[pulumi.Input[str]] = None,
                 min_days_remaining: Optional[pulumi.Input[int]] = None,
                 must_staple: Optional[pulumi.Input[bool]] = None,
                 pre_check_delay: Optional[pulumi.Input[int]] = None,
                 ...
                 revoke_certificate_on_destroy: Optional[pulumi.Input[bool]] = None,
                 subject_alternative_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tls_challenge: Optional[pulumi.Input[pulumi.InputType['AcmeCertificateTlsChallengeArgs']]] = None,
                 __props__=None):
        """
        Create a AcmeCertificate resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AcmeCertificateArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a AcmeCertificate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param AcmeCertificateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AcmeCertificateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AcmeCertificateArgs.__new__(AcmeCertificateArgs)
        ...
        super(AcmeCertificate, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            revoke_certificate_on_destroy: Optional[pulumi.Input[bool]] = None,
            subject_alternative_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            tls_challenge: Optional[pulumi.Input[pulumi.InputType['AcmeCertificateTlsChallengeArgs']]] = None) -> 'AcmeCertificate':
        """
        ...
        __props__ = _AcmeCertificateState.__new__(_AcmeCertificateState)
        ...
        __props__.__dict__["subject_alternative_names"] = subject_alternative_names
        __props__.__dict__["tls_challenge"] = tls_challenge
        return AcmeCertificate(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dnsChallenges")
    def dns_challenges(self) -> pulumi.Output[Optional[Sequence['outputs.AcmeCertificateDnsChallenge']]]:
        return pulumi.get(self, "dns_challenges")

    @property
    @pulumi.getter(name="httpChallenge")
    def http_challenge(self) -> pulumi.Output[Optional['outputs.AcmeCertificateHttpChallenge']]:
        return pulumi.get(self, "http_challenge")

    @property
    @pulumi.getter(name="httpMemcachedChallenge")
    def http_memcached_challenge(self) -> pulumi.Output[Optional['outputs.AcmeCertificateHttpMemcachedChallenge']]:
        return pulumi.get(self, "http_memcached_challenge")

    @property
    @pulumi.getter(name="httpWebrootChallenge")
    def http_webroot_challenge(self) -> pulumi.Output[Optional['outputs.AcmeCertificateHttpWebrootChallenge']]:
        return pulumi.get(self, "http_webroot_challenge")
    ...
    @property
    @pulumi.getter(name="tlsChallenge")
    def tls_challenge(self) -> pulumi.Output[Optional['outputs.AcmeCertificateTlsChallenge']]:
        return pulumi.get(self, "tls_challenge")
