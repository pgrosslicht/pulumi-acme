...
import (
	...
	"github.com/pgrosslicht/pulumi-acme/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			"acme_registration": {Tok: tfbridge.MakeResource(mainPkg, mainMod, "AcmeRegistration")},
			"acme_certificate":  {Tok: tfbridge.MakeResource(mainPkg, mainMod, "AcmeCertificate")},
